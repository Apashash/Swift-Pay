...
const navigation: { label: string; items: AdminNavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/numeros-retrait', label: 'Numéros de retrait', icon: Smartphone },
    ],
  },
  {
    label: 'Configuration',
    items: [
      { href: '/admin/frais', label: 'Frais', icon: CircleDollarSign },
      { href: '/admin/conversions', label: 'Conversions', icon: Calculator },
      { href: '/admin/pays-operateurs', label: 'Pays & opérateurs', icon: Globe2 },
      { href: '/admin/afribapay', label: 'AfribaPay', icon: ShieldCheck },
      { href: '/admin/authenticator', label: 'Authenticator', icon: KeyRound },
    ],
  },
];
