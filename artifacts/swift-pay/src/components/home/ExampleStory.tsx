  ...
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto bg-card border border-border rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden">
          <div className="absolute inset-0 opacity-[0.02] bg-[linear-gradient(rgba(0,0,0,0.5)_1px,transparent_1px),linear-gradient(90deg,rgba(0,0,0,0.5)_1px,transparent_1px)] bg-[size:30px_30px]" />
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center relative z-10">
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  <div className="w-8 h-8 rounded-full bg-secondary flex items-center justify-center mt-1 flex-shrink-0">
                    <span className="text-foreground text-sm font-bold">1</span>
                  </div>
                  <div>
                    <h4 className="text-foreground font-medium">{t('ex_step1_title')}</h4>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-foreground font-medium">{t('ex_step2_title')}</h4>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-foreground font-medium">{t('ex_step3_title')}</h4>
            ...
            <div className="relative">
              <motion.div
                ...
                className="bg-background border border-border rounded-2xl p-6 max-w-sm mx-auto shadow-2xl"
              >
                <div className="text-center border-b border-border pb-6 mb-6">
                  <div className="w-16 h-16 bg-primary/20 rounded-full flex items-center justify-center mx-auto mb-4 text-primary">
                    <SiTether size={28} />
                  </div>
                  <h3 className="text-2xl font-bold text-foreground mb-1">{t('ex_receipt_title')}</h3>
                ...
                <div className="space-y-4 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="text-foreground font-mono">46.25 USDT</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">{t('ex_rate')}</span>
                    <span className="text-foreground font-mono">1 USDT = 648.6 FCFA</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">{t('ex_fee')}</span>
                    <span className="text-foreground font-mono">0.46 USDT</span>
                  </div>
                ...
                <div className="mt-8 bg-muted border border-border/50 rounded-lg p-3 flex items-center gap-3">
