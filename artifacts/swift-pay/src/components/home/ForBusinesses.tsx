          ...
          <div className="grid lg:grid-cols-2">
            ...
            <div className="p-10 md:p-16 flex flex-col justify-center">
              ...
              <p className="text-muted-foreground text-lg mb-8">
                E-commerce stores and local businesses can integrate SwiftPay to accept global crypto payments. Your customer pays in USDT, you receive FCFA directly in your Mobile Money or bank account instantly.
              </p>
              
              <ul className="space-y-3 mb-10">
                <li className="flex items-center gap-3 text-white">
                  <div className="w-1.5 h-1.5 rounded-full bg-primary" /> No crypto wallet management
                </li>
                <li className="flex items-center gap-3 text-white">
                  <div className="w-1.5 h-1.5 rounded-full bg-primary" /> Zero exposure to volatility
                </li>
                <li className="flex items-center gap-3 text-white">
                  <div className="w-1.5 h-1.5 rounded-full bg-primary" /> Webhooks for instant order fulfillment
                </li>
              </ul>
