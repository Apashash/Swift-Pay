...
export const translations = {
  fr: {
    ...
    hiw_step5_desc: 'SwiftPay convertit instantanément la crypto en monnaie locale.',
    ...
    ex_step1_title: 'Ali ouvre SwiftPay',
    ...
    ex_step3_desc: 'Son téléphone vibre avec un dépôt Orange Money de exactement 30 000 FCFA.',
    ...
    um_verified_desc: 'Pour les utilisateurs réguliers et les entreprises. Débloquez toute la puissance de SwiftPay.',
    ...
    fb_desc: 'Les boutiques e-commerce et les entreprises locales peuvent intégrer SwiftPay pour accepter des paiements crypto mondiaux. Votre client paie en USDT, vous recevez des FCFA directement sur votre Mobile Money ou compte bancaire instantanément.',
    ...
    footer_rights: '© 2025 SwiftPay. Tous droits réservés.',
  ...
  en: {
    ...
    hiw_step5_desc: 'SwiftPay instantly converts the crypto into local fiat.',
    hiw_step6_title: 'Mobile payout',
    hiw_step6_desc: "API triggers direct deposit to the recipient's Mobile Money account.",
    hiw_step7_title: 'Confirmation',
    ...
    ex_step1_title: 'Ali opens SwiftPay',
    ...
    ex_step3_desc: 'Her phone buzzes with an Orange Money deposit of exactly 30 000 FCFA.',
    ...
    um_verified_desc: 'For regular users and businesses. Unlock the full power of SwiftPay.',
    ...
    fb_desc: 'E-commerce stores and local businesses can integrate SwiftPay to accept global crypto payments. Your customer pays in USDT, you receive FCFA directly in your Mobile Money or bank account instantly.',
    ...
    footer_rights: '© 2025 SwiftPay. All rights reserved.',
